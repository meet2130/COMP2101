...
###########################################################
# summarizes and report in what we have the directory
###########################################################
...
###########################################################
# to hand =le the tyar tarfile
###########################################################

#DOwnload the tar file
test -f ~/Pictures/pics.zip || wget -q -O ~/Pictures/pics.tgz http://zonzorp.net/pics.tgz

#unpack the tarfile if we need and delate it

test -f ~/Pictures/pics.tgz && (tar zxvf ~/Pictures/pics.tgz -C ~/Pictures | awk '{$9}') && rm ~/Pictures/pics.tgz
